...
\subparagraph{Water Gem}
This magic sapphire has 3 charges.
During your wild shape, you can expend charges to activate one of the following effects.

\paragraph{Life Transfer}
The first time you hit during your next attack action, you may expend a charge to mark each creature you hit.
The next attack that hits a marked creature deals 2d8 necrotic damage.
The attacker gains hit points equal to that damage.

\paragraph{The Essence of Life}
When you touch a wounded creature that is not an undead or construct, you can expend a charge.
If you do so, you use an action to heal them by 1d8 + your spellcasting ability modifier.

\paragraph{At Home in Water}
As a bonus action, you may expend a charge to gain a swimming speed equal to your walking speed.
